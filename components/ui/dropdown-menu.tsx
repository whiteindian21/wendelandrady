...
function DropdownMenuItem({
  ...
  return <DropdownMenuPrimitive.Item className={cn(DropdownMenuItemClass, className)} {...props} />;
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(DropdownMenuItemClass, "data-[state=open]:bg-accent data-[state=open]:text-accent-foreground", className)}
      {...props}
    >
      {children}
